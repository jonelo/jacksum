...
public class HashAlgorithm implements Comparable<HashAlgorithm> {
    ...
    static {
        ...
        // aliases
        WEIGHTS.put("adler32", WEIGHTS.get("adler32"));
        WEIGHTS.put("adler-32", WEIGHTS.get("adler32"));
        WEIGHTS.put("blake-224", WEIGHTS.get("blake224"));
        WEIGHTS.put("blake-256", WEIGHTS.get("blake256"));
        WEIGHTS.put("blake-384", WEIGHTS.get("blake384"));
        WEIGHTS.put("blake-512", WEIGHTS.get("blake512"));
        WEIGHTS.put("b2sum-8", WEIGHTS.get("blake2b-8"));
        WEIGHTS.put("b2sum-16", WEIGHTS.get("blake2b-16"));
        WEIGHTS.put("b2sum-24", WEIGHTS.get("blake2b-24"));
        WEIGHTS.put("b2sum-32", WEIGHTS.get("blake2b-32"));
        WEIGHTS.put("b2sum-40", WEIGHTS.get("blake2b-40"));
        WEIGHTS.put("b2sum-48", WEIGHTS.get("blake2b-48"));
        WEIGHTS.put("b2sum-56", WEIGHTS.get("blake2b-56"));
        WEIGHTS.put("b2sum-64", WEIGHTS.get("blake2b-64"));
        WEIGHTS.put("b2sum-72", WEIGHTS.get("blake2b-72"));
        WEIGHTS.put("b2sum-80", WEIGHTS.get("blake2b-80"));
        WEIGHTS.put("b2sum-88", WEIGHTS.get("blake2b-88"));
        WEIGHTS.put("b2sum-96", WEIGHTS.get("blake2b-96"));
        WEIGHTS.put("b2sum-104", WEIGHTS.get("blake2b-104"));
        WEIGHTS.put("b2sum-112", WEIGHTS.get("blake2b-112"));
        WEIGHTS.put("b2sum-120", WEIGHTS.get("blake2b-120"));
        WEIGHTS.put("b2sum-128", WEIGHTS.get("blake2b-128"));
        WEIGHTS.put("b2sum-136", WEIGHTS.get("blake2b-136"));
        WEIGHTS.put("b2sum-144", WEIGHTS.get("blake2b-144"));
        WEIGHTS.put("b2sum-152", WEIGHTS.get("blake2b-152"));
        WEIGHTS.put("b2sum-160", WEIGHTS.get("blake2b-160"));
        WEIGHTS.put("b2sum-168", WEIGHTS.get("blake2b-168"));
        WEIGHTS.put("b2sum-176", WEIGHTS.get("blake2b-176"));
        WEIGHTS.put("b2sum-184", WEIGHTS.get("blake2b-184"));
        WEIGHTS.put("b2sum-192", WEIGHTS.get("blake2b-192"));
        WEIGHTS.put("b2sum-200", WEIGHTS.get("blake2b-200"));
        WEIGHTS.put("b2sum-208", WEIGHTS.get("blake2b-208"));
        WEIGHTS.put("b2sum-216", WEIGHTS.get("blake2b-216"));
        WEIGHTS.put("b2sum-224", WEIGHTS.get("blake2b-224"));
        WEIGHTS.put("b2sum-232", WEIGHTS.get("blake2b-232"));
        WEIGHTS.put("b2sum-240", WEIGHTS.get("blake2b-240"));
        WEIGHTS.put("b2sum-248", WEIGHTS.get("blake2b-248"));
        WEIGHTS.put("b2sum-256", WEIGHTS.get("blake2b-256"));
        WEIGHTS.put("b2sum-264", WEIGHTS.get("blake2b-264"));
        WEIGHTS.put("b2sum-272", WEIGHTS.get("blake2b-272"));
        WEIGHTS.put("b2sum-280", WEIGHTS.get("blake2b-280"));
        WEIGHTS.put("b2sum-288", WEIGHTS.get("blake2b-288"));
        WEIGHTS.put("b2sum-296", WEIGHTS.get("blake2b-296"));
        WEIGHTS.put("b2sum-304", WEIGHTS.get("blake2b-304"));
        WEIGHTS.put("b2sum-312", WEIGHTS.get("blake2b-312"));
        WEIGHTS.put("b2sum-320", WEIGHTS.get("blake2b-320"));
        WEIGHTS.put("b2sum-328", WEIGHTS.get("blake2b-328"));
        WEIGHTS.put("b2sum-336", WEIGHTS.get("blake2b-336"));
        WEIGHTS.put("b2sum-344", WEIGHTS.get("blake2b-344"));
        WEIGHTS.put("b2sum-352", WEIGHTS.get("blake2b-352"));
        WEIGHTS.put("b2sum-360", WEIGHTS.get("blake2b-360"));
        WEIGHTS.put("b2sum-368", WEIGHTS.get("blake2b-368"));
        WEIGHTS.put("b2sum-376", WEIGHTS.get("blake2b-376"));
        WEIGHTS.put("b2sum-384", WEIGHTS.get("blake2b-384"));
        WEIGHTS.put("b2sum-392", WEIGHTS.get("blake2b-392"));
        WEIGHTS.put("b2sum-400", WEIGHTS.get("blake2b-400"));
        WEIGHTS.put("b2sum-408", WEIGHTS.get("blake2b-408"));
        WEIGHTS.put("b2sum-416", WEIGHTS.get("blake2b-416"));
        WEIGHTS.put("b2sum-424", WEIGHTS.get("blake2b-424"));
        WEIGHTS.put("b2sum-432", WEIGHTS.get("blake2b-432"));
        WEIGHTS.put("b2sum-440", WEIGHTS.get("blake2b-440"));
        WEIGHTS.put("b2sum-448", WEIGHTS.get("blake2b-448"));
        WEIGHTS.put("b2sum-456", WEIGHTS.get("blake2b-456"));
        WEIGHTS.put("b2sum-464", WEIGHTS.get("blake2b-464"));
        WEIGHTS.put("b2sum-472", WEIGHTS.get("blake2b-472"));
        WEIGHTS.put("b2sum-480", WEIGHTS.get("blake2b-480"));
        WEIGHTS.put("b2sum-488", WEIGHTS.get("blake2b-488"));
        WEIGHTS.put("b2sum-496", WEIGHTS.get("blake2b-496"));
        WEIGHTS.put("b2sum-504", WEIGHTS.get("blake2b-504"));
        WEIGHTS.put("blake2b", WEIGHTS.get("blake2b-512"));
        WEIGHTS.put("b2sum-512", WEIGHTS.get("blake2b-512"));
        WEIGHTS.put("b2sum", WEIGHTS.get("blake2b-512"));
        WEIGHTS.put("blake2s", WEIGHTS.get("blake2s-256"));
        WEIGHTS.put("blake3-256", WEIGHTS.get("blake3"));
        WEIGHTS.put("b3sum", WEIGHTS.get("blake3"));
        WEIGHTS.put("crc-8", WEIGHTS.get("crc8"));
        WEIGHTS.put("crc-16", WEIGHTS.get("crc16"));
        WEIGHTS.put("crc-16_minix", WEIGHTS.get("crc16_minix"));
        WEIGHTS.put("crc-24", WEIGHTS.get("crc24"));
        WEIGHTS.put("crc-32", WEIGHTS.get("crc32"));
        WEIGHTS.put("fcs32", WEIGHTS.get("crc32"));
        WEIGHTS.put("fcs-32", WEIGHTS.get("crc32"));
        WEIGHTS.put("crc-32_mpeg-2", WEIGHTS.get("crc32_mpeg2"));
        WEIGHTS.put("crc-32_bzip2", WEIGHTS.get("crc32_bzip2"));
        WEIGHTS.put("crc-32_bzip-2", WEIGHTS.get("crc32_bzip2"));
        ...
        WEIGHTS.put("crc-64_go-iso", WEIGHTS.get("crc64_go-iso"));
        WEIGHTS.put("crc-64_xz", WEIGHTS.get("crc64_xz"));
        WEIGHTS.put("crc64_go-ecma", WEIGHTS.get("crc64_xz"));
        WEIGHTS.put("crc-64_go-ecma", WEIGHTS.get("crc64_xz"));
        WEIGHTS.put("dha-256", WEIGHTS.get("dha256"));
        WEIGHTS.put("echo-224", WEIGHTS.get("echo224"));
        WEIGHTS.put("echo-256", WEIGHTS.get("echo256"));
        WEIGHTS.put("echo-384", WEIGHTS.get("echo384"));
        WEIGHTS.put("echo-512", WEIGHTS.get("echo512"));
        WEIGHTS.put("emule", WEIGHTS.get("ed2k"));
        WEIGHTS.put("edonkey", WEIGHTS.get("ed2k"));
        WEIGHTS.put("elf32", WEIGHTS.get("elf"));
        WEIGHTS.put("elf-32", WEIGHTS.get("elf"));
        WEIGHTS.put("fcs-16", WEIGHTS.get("fcs16"));
        WEIGHTS.put("crc16_x25", WEIGHTS.get("fcs16"));
        WEIGHTS.put("crc-16_x-25", WEIGHTS.get("fcs16"));
        WEIGHTS.put("fletcher-16", WEIGHTS.get("fletcher16"));
        WEIGHTS.put("fork-256", WEIGHTS.get("fork256"));
        WEIGHTS.put("fugue-224", WEIGHTS.get("fugue224"));
        WEIGHTS.put("fugue-256", WEIGHTS.get("fugue256"));
        WEIGHTS.put("fugue-384", WEIGHTS.get("fugue384"));
        WEIGHTS.put("fugue-512", WEIGHTS.get("fugue512"));
        WEIGHTS.put("groestl224", WEIGHTS.get("groestl-224"));
        WEIGHTS.put("groestl256", WEIGHTS.get("groestl-256"));
        WEIGHTS.put("groestl384", WEIGHTS.get("groestl-384"));
        WEIGHTS.put("groestl512", WEIGHTS.get("groestl-512"));
        WEIGHTS.put("gost:default", WEIGHTS.get("gost"));
        WEIGHTS.put("has-160", WEIGHTS.get("has160"));
        WEIGHTS.put("haval", WEIGHTS.get("haval_128_3"));
        WEIGHTS.put("jh-224", WEIGHTS.get("jh224"));
        WEIGHTS.put("jh-256", WEIGHTS.get("jh256"));
        WEIGHTS.put("jh-384", WEIGHTS.get("jh384"));
        WEIGHTS.put("jh-512", WEIGHTS.get("jh512"));
        WEIGHTS.put("joaat32", WEIGHTS.get("joaat"));
        WEIGHTS.put("joaat-32", WEIGHTS.get("joaat"));
        WEIGHTS.put("kangaroo12", WEIGHTS.get("kangarootwelve"));
        WEIGHTS.put("k12", WEIGHTS.get("kangarootwelve"));
        WEIGHTS.put("keccak-224", WEIGHTS.get("keccak224"));
        WEIGHTS.put("keccak-256", WEIGHTS.get("keccak256"));
        WEIGHTS.put("keccak-288", WEIGHTS.get("keccak288"));
        WEIGHTS.put("keccak-284", WEIGHTS.get("keccak384"));
        WEIGHTS.put("keccak-512", WEIGHTS.get("keccak512"));
        WEIGHTS.put("luffa-224", WEIGHTS.get("luffa224"));
        WEIGHTS.put("luffa-256", WEIGHTS.get("luffa256"));
        WEIGHTS.put("luffa-384", WEIGHTS.get("luffa384"));
        WEIGHTS.put("luffa-512", WEIGHTS.get("luffa512"));
        WEIGHTS.put("marsupilami14", WEIGHTS.get("marsupilamifourteen"));
        WEIGHTS.put("m14", WEIGHTS.get("marsupilamifourteen"));
        WEIGHTS.put("md2sum", WEIGHTS.get("md2"));
        WEIGHTS.put("md4sum", WEIGHTS.get("md4"));
        WEIGHTS.put("md5sum", WEIGHTS.get("md5"));
        WEIGHTS.put("mdc-2", WEIGHTS.get("mdc2"));
        WEIGHTS.put("radiogatun", WEIGHTS.get("radiogatun:64"));
        WEIGHTS.put("ripemd-128", WEIGHTS.get("ripemd128"));
        WEIGHTS.put("ripe-md128", WEIGHTS.get("ripemd128"));
        WEIGHTS.put("rmd128", WEIGHTS.get("ripemd128"));
        WEIGHTS.put("rmd-128", WEIGHTS.get("ripemd128"));
        WEIGHTS.put("ripemd-160", WEIGHTS.get("ripemd160"));
        WEIGHTS.put("ripe-md160", WEIGHTS.get("ripemd160"));
        WEIGHTS.put("rmd160", WEIGHTS.get("ripemd160"));
        WEIGHTS.put("rmd-160", WEIGHTS.get("ripemd160"));
        WEIGHTS.put("ripemd-256", WEIGHTS.get("ripemd256"));
        WEIGHTS.put("ripe-md256", WEIGHTS.get("ripemd256"));
        WEIGHTS.put("rmd256", WEIGHTS.get("ripemd256"));
        WEIGHTS.put("rmd-256", WEIGHTS.get("ripemd256"));
        WEIGHTS.put("ripemd-320", WEIGHTS.get("ripemd320"));
        WEIGHTS.put("ripe-md320", WEIGHTS.get("ripemd320"));
        WEIGHTS.put("rmd320", WEIGHTS.get("ripemd320"));
        WEIGHTS.put("rmd-320", WEIGHTS.get("ripemd320"));
        WEIGHTS.put("sha-0", WEIGHTS.get("sha0"));
        WEIGHTS.put("sha1sum", WEIGHTS.get("sha1"));
        WEIGHTS.put("sha", WEIGHTS.get("sha1"));
        WEIGHTS.put("sha-1", WEIGHTS.get("sha1"));
        WEIGHTS.put("sha160", WEIGHTS.get("sha1"));
        WEIGHTS.put("sha-160", WEIGHTS.get("sha1"));
        WEIGHTS.put("dss1", WEIGHTS.get("sha1"));
        WEIGHTS.put("sha-224", WEIGHTS.get("sha224"));
        WEIGHTS.put("sha-256", WEIGHTS.get("sha256"));
        WEIGHTS.put("sha-384", WEIGHTS.get("sha384"));
        WEIGHTS.put("sha-512", WEIGHTS.get("sha512"));
        WEIGHTS.put("sha-512/224", WEIGHTS.get("sha512/224"));
        WEIGHTS.put("sha-512/256", WEIGHTS.get("sha512/256"));
        WEIGHTS.put("sha-3-224", WEIGHTS.get("sha3-224"));
        WEIGHTS.put("sha-3-256", WEIGHTS.get("sha3-256"));
        WEIGHTS.put("sha-3-384", WEIGHTS.get("sha3-384"));
        WEIGHTS.put("sha-3-512", WEIGHTS.get("sha3-512"));
        WEIGHTS.put("skein-256", WEIGHTS.get("skein-256-256"));
        WEIGHTS.put("skein-512", WEIGHTS.get("skein-512-512"));
        WEIGHTS.put("skein-1024", WEIGHTS.get("skein-1024-1024"));
        WEIGHTS.put("streebog-256", WEIGHTS.get("streebog256"));
        WEIGHTS.put("streebog-512", WEIGHTS.get("streebog512"));
        WEIGHTS.put("sumbsd", WEIGHTS.get("sum_bsd"));
        WEIGHTS.put("bsd", WEIGHTS.get("sum_bsd"));
        WEIGHTS.put("bsdsum", WEIGHTS.get("sum_bsd"));
        WEIGHTS.put("sumsysv", WEIGHTS.get("sum_sysv"));
        WEIGHTS.put("sysv", WEIGHTS.get("sum_sysv"));
        WEIGHTS.put("sysvsum", WEIGHTS.get("sum_sysv"));
        WEIGHTS.put("sum-8", WEIGHTS.get("sum8"));
        WEIGHTS.put("sum-16", WEIGHTS.get("sum16"));
        WEIGHTS.put("sum-24", WEIGHTS.get("sum24"));
        WEIGHTS.put("sum-32", WEIGHTS.get("sum32"));
        WEIGHTS.put("sum-40", WEIGHTS.get("sum40"));
        WEIGHTS.put("sum-48", WEIGHTS.get("sum48"));
        WEIGHTS.put("sum-56", WEIGHTS.get("sum56"));
        WEIGHTS.put("tiger-128", WEIGHTS.get("tiger128"));
        WEIGHTS.put("tiger-160", WEIGHTS.get("tiger160"));
        WEIGHTS.put("tiger192", WEIGHTS.get("tiger"));
        WEIGHTS.put("tiger-192", WEIGHTS.get("tiger"));
        WEIGHTS.put("tree:tiger192", WEIGHTS.get("tree:tiger"));
        WEIGHTS.put("tree:tiger-192", WEIGHTS.get("tree:tiger"));
        WEIGHTS.put("tth", WEIGHTS.get("tree:tiger"));
        WEIGHTS.put("tth2", WEIGHTS.get("tree:tiger2"));
        WEIGHTS.put("vsh-1024", WEIGHTS.get("vsh"));
        WEIGHTS.put("whirlpool-0", WEIGHTS.get("whirlpool0"));
        WEIGHTS.put("whirlpool-l", WEIGHTS.get("whirlpool1"));
        WEIGHTS.put("whirlpool-t", WEIGHTS.get("whirlpool1"));
        WEIGHTS.put("whirlpool", WEIGHTS.get("whirlpool2"));
        WEIGHTS.put("whirlpool-2", WEIGHTS.get("whirlpool2"));
        WEIGHTS.put("xor-8", WEIGHTS.get("xor8"));
        WEIGHTS.put("xxh32", WEIGHTS.get("xxhash32"));
        // GENERATION END
    }
        ...
        try {
            ...
            for (String hash : hashes) {
                ...
                for (String alias : aliases) {
                    System.out.printf("WEIGHTS.put(\"%s\", WEIGHTS.get(\"%s\"));\n", alias, hash);
                }
            }
