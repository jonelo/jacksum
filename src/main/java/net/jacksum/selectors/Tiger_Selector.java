 ...
 * @author johann
 */
public class Tiger_Selector extends Selector {

    private final static String ID = "tiger";
    private final static String DESCRIPTION = "Tiger (Tiger/192)";
    ...
    public AbstractChecksum getPrimaryImplementation() throws NoSuchAlgorithmException {
        return new MDgnu(net.jacksum.zzadopt.gnu.crypto.Registry.TIGER_HASH);
    }
