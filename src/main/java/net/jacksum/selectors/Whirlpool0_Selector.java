 ...
 * @author johann
 */
public class Whirlpool0_Selector extends Selector {

    
    private final static String ID = "whirlpool0";
    private final static String DESCRIPTION = "Whirlpool-0";
    ...
    public AbstractChecksum getPrimaryImplementation() throws NoSuchAlgorithmException {
        return new MDgnu(net.jacksum.zzadopt.gnu.crypto.Registry.WHIRLPOOL2000_HASH);
    }
