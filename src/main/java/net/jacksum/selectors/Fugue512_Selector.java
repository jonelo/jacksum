...
import net.jacksum.algorithms.md.Fugue_512;
 ...
 * @author johann
 */
public class Fugue512_Selector extends Selector {
    ...
    public AbstractChecksum getPrimaryImplementation() throws NoSuchAlgorithmException {
        return new MDCryptohashSphlib3(net.jacksum.zzadopt.fr.cryptohash.ext.Registry.FUGUE512);
    }

    @Override
    public AbstractChecksum getAlternateImplementation() throws NoSuchAlgorithmException {
        return new MD(new Fugue_512(), -4);
    }
