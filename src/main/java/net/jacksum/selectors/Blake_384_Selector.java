 ...
 * @author johann
 */
public class Blake_384_Selector extends Selector {

    private final static String ID = "blake384";
    private final static String DESCRIPTION = "BLAKE-384";
    private final static String ALIAS = "blake-384";
    ...
    public AbstractChecksum getPrimaryImplementation() throws NoSuchAlgorithmException {
        return new MDCryptohashSphlib3(net.jacksum.zzadopt.fr.cryptohash.ext.Registry.BLAKE384);
    }
