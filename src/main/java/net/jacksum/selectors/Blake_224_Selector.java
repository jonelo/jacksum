 ...
 * @author johann
 */
public class Blake_224_Selector extends Selector {

    private final static String ID = "blake224";
    private final static String DESCRIPTION = "BLAKE-224";
    private final static String ALIAS = "blake-224";
    ...
    public AbstractChecksum getPrimaryImplementation() throws NoSuchAlgorithmException {
        return new MDCryptohashSphlib3(net.jacksum.zzadopt.fr.cryptohash.ext.Registry.BLAKE224);
    }
