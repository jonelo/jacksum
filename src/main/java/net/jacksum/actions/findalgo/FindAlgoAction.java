...
import net.jacksum.actions.findalgo.engines.FindKnownCRC;
import net.jacksum.actions.findalgo.engines.FindDocumentedAlgorithms;
import net.jacksum.actions.findalgo.engines.BruteForceCRC;
...
public class FindAlgoAction implements Action {
    ...
    public int perform() throws ParameterException, ExitException {
        ...
        if (matcher.find() && matcher.groupCount() == 1) {
            ...
            // engines.add(new BruteForceCRC_Extended(parameters); // extended Rocksoft Model where the size is calculated into the the crc
