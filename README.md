...
- Multi-threading across platforms for parallel hash calculations and
  ...
  fast SSD storage
- 553 standard hash functions
- HMAC support for 488 hash functions
